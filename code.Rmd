...
## loading data 
The data frame is build up from sample number and read counts. Each sample has 
...
lesonal_data <- phenodata$characteristics_ch1.5
#nonlesonal_data <-
merge(my_data, annotaion, by.x = "row.names", by.y = "column.names")
```
